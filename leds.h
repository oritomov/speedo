...
#define trip_hundreds_driver	0b00000110 // y3
#define trip_tens_driver		0b00001000 // y4
#define trip_ones_driver		0b00001100 // y5
#define trip_100m_driver		0b00001010 // y6
//								      bacg
#define distance_6_driver		0b00001001 // y2
#define distance_5_driver		0b00000101 // y1
#define distance_4_driver		0b00000011 // y4
#define distance_3_driver		0b00001101 // y3
#define distance_2_driver		0b00001011 // y6
#define distance_1_driver		0b00000111 // y5
